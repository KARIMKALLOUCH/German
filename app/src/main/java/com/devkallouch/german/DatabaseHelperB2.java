...
public class DatabaseHelperB2 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "cardsss2.db";
    private static final int DATABASE_VERSION = 1;

    public static final String TABLE_NAME = "card_status";
    public static final String COLUMN_ID = "id";
    public static final String COLUMN_IS_READ = "isRead3";

    public DatabaseHelperB2(Context context) {
