...
public class DatabaseHelperB1 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "cardsss1.db";
    private static final int DATABASE_VERSION = 1;

    public static final String TABLE_NAME = "card_status";
    public static final String COLUMN_ID = "id";
    public static final String COLUMN_IS_READ = "isRead2";

    public DatabaseHelperB1(Context context) {
